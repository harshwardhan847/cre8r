...
const BlogsPreview = () => {
  ...
  return (
    <div className="w-full py-24 bg-background flex flex-col items-center justify-center border-t border-border/10">
      <div className="container px-4 md:px-8 mx-auto flex flex-col gap-8 max-w-7xl">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4">
          <div className="max-w-2xl">
            <h2 className="text-4xl font-medium tracking-tight text-foreground">Latest Insights</h2>
            <p className="text-muted-foreground mt-2 text-lg">Stay updated with the latest in influencer marketing, trends, and strategies.</p>
          </div>
          ...
          {previewBlogs.map((blog) => (
            ...
            >
              ...
              <div className="p-6 md:p-8 flex flex-col flex-1 gap-4">
                ...
                <h3 className="text-xl md:text-2xl font-semibold leading-snug group-hover:text-primary transition-colors line-clamp-3">
                  {blog.title}
                </h3>
